<?php
  ...
  foreach ($detail as $d) {
    ...
    <tr>
      <td><?=$i++?></td>
      <td style="min-width:230px;"><?php echo $d->nama_kelas; ?></td>
      <td><?php echo $d->jumlah_peserta; ?></td>
      <td><?php echo $d->jumlah_pemateri; ?></td>
      <td><?php echo "$d->tgl_buka sampai $d->tgl_selesai"; ?></td>
      ...
      <td class="text-center" style="min-width:230px;">
        <button class="btn btn-success update-dataPegawai" data-id="<?php echo $d->id_kelas; ?>"><i class="glyphicon glyphicon-eye-open"></i></button>
